...
*  Earth: Petrified.  The affected character is unable to use the Move action, and their base Evasion counts as being half its current value rounded down, including buffs and debuffs.  They may still advance as normal.
